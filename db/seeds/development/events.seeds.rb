...
event.dates.create(start: Time.new(2013, 9, 24, 16, 30).to_i, end: Time.new(2013, 9, 24, 20, 30).to_i)
event.dates.create(start: Time.new(2013, 9, 25, 18, 30).to_i, end: Time.new(2013, 9, 25, 22, 30).to_i)
event.dates.create(start: Time.new(2013, 9, 30, 16, 30).to_i, end: Time.new(2013, 9, 30, 20, 30).to_i)
